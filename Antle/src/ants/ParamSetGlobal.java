...
public final class ParamSetGlobal extends ParamSet {
	...
	public ParamSetGlobal() {
		...
		arrayQueue.add(stoneLayerCutoff		= new Param(false,	false,	false,	-1,		1,			.3,				"Stone layer cutoff"));
		arrayQueue.add(earthNoiseScale		= new Param(false,	false,	false,	.4,		.01,		.07,			"Earth noise scale"));
